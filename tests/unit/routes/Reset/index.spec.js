...
describe('Routes', () => {
  describe('Reset', () => {
    describe('Routing', () => {
      let sandbox, injectReducerStub, resetRoute, allStub, catchStub, cbStub, nextStateStub;
      ...
      it('Should return if authentication set and auth returns false', () => {
        ...
        const ret = resetRoute(store, authStub).getComponent(nextStateStub, cbStub);
      ...
      it('Should require relevant files in a promise chain', () => {
        ...
        resetRoute(store, authStub).getComponent(nextStateStub, cbStub);
